...
- Before running any of the app's backend, make sure you have the proper `.env` file in `/src`. If you don't have it, look [here](https://drive.google.com/drive/folders/15Vtm-YK303sm12XBZ4_uBbRHBYp2yYIj?usp=sharing).
